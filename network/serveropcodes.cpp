...
const ToServerCommandHandler toServerCommandTable[TOSERVER_NUM_MSG_TYPES] =
{
	...
	{ "TOSERVER_KINECT",        TOSERVER_STATE_INGAME, &Server::handleCommand_KinectPlayerHead }, // 0x4d
	null_command_handler, // 0x4e
	{ "TOSERVER_PDATA",        TOSERVER_STATE_INGAME, &Server::handleCommand_KinectPlayerArms }, // 0x4f
...
const ClientCommandFactory clientCommandFactoryTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_KINECT_ARMS",              0, true }, // 0x3e
