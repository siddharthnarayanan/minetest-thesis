...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_KINECT_ARMS",              TOCLIENT_STATE_CONNECTED, &Client::handleCommand_KinectPlayerArms }, // 0x3e
	...
	null_command_handler,
	null_command_handler,
	{ "TOCLIENT_PDATA",              	   TOCLIENT_STATE_CONNECTED, &Client::handleCommand_PdataPlayer }, // 0x5e
	{ "TOCLIENT_KINECT_HEAD",              TOCLIENT_STATE_CONNECTED, &Client::handleCommand_KinectPlayerHead }, // 0x5f
...
const ServerCommandFactory serverCommandFactoryTable[TOSERVER_NUM_MSG_TYPES] =
{
	...
	{ "TOSERVER_KINECT_HEAD",        0, true }, // 0x4d
	{ "TOSERVER_KINECT_LEGS",        0, true }, // 0x4e
	{ "TOSERVER_KINECT_ARMS",        0, true }, // 0x4f
