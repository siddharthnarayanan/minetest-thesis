...
void set_default_settings(Settings *settings)
{
	...
	settings->setDefault("kinectport", "52505");
	settings->setDefault("pdataport", "52557");
	...
	settings->setDefault("keymap_mirror", "KEY_KEY_M");
	settings->setDefault("keymap_upperhalf", "KEY_KEY_U");
	...
	settings->setDefault("keymap_gender", "KEY_KEY_G");
	settings->setDefault("keymap_noclip", "KEY_KEY_H");
	settings->setDefault("keymap_kinect_toggle", "KEY_F8");
	...
	settings->setDefault("kinectaddress", "");
	settings->setDefault("pdataaddress", "");
