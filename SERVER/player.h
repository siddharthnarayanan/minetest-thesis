...
public:
	...
	f32 getKinectTorsoRot()
	{
		...
		//22222dstream << "player:  " << m_name << "        getKinectTorsoRot() :  " << m_kinect_torso_rot << std::endl;
	...
	void setKinectTorsoRot(f32 kinecttorsorot)  //KINECT TO DO ??
	{
		...
		//22222dstream << "player:  " << m_name << " now running setKinectTorsoRot () : Setting m_kinect_torso_rot to " << m_kinect_right_leg << std::endl;
