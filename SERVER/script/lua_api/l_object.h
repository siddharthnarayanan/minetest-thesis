...
private:
	...
	// set_bone_position_quaternion(self, std::string bone, v3f position, v3f rotation)
	static int l_set_bone_position_quaternion(lua_State *L);
	...
	static int l_get_kinect_pitch(lua_State *L);
	
	// get_kinect_yaw(self)
	static int l_get_kinect_yaw(lua_State *L);
	
	// get_kinect_roll(self)
	static int l_get_kinect_roll(lua_State *L);
	
	// get_kinect_arm_l(self)
	static int l_get_kinect_arm_l(lua_State *L);
	
	// get_kinect_shoulder_l(self)
	static int l_get_kinect_shoulder_l(lua_State *L);
	
	// get_kinect_arm_l_OrthoX(self)
	static int l_get_kinect_arm_l_OrthoX(lua_State *L);
	
	// get_kinect_arm_l_OrthoZ(self)
	static int l_get_kinect_arm_l_OrthoZ(lua_State *L);
	
	// get_kinect_arm_r(self)
	static int l_get_kinect_arm_r(lua_State *L);
	
	// get_kinect_shoulder_r(self)
	static int l_get_kinect_shoulder_r(lua_State *L);
	
	// get_kinect_arm_r_OrthoX(self)
	static int l_get_kinect_arm_r_OrthoX(lua_State *L);
	
	// get_kinect_arm_r_OrthoZ(self)
	static int l_get_kinect_arm_r_OrthoZ(lua_State *L);
	
	// get_kinect_leg_l(self)
	static int l_get_kinect_leg_l(lua_State *L);
	
	// get_kinect_leg_l_OrthoX(self)
	static int l_get_kinect_leg_l_OrthoX(lua_State *L);
	
	// get_kinect_leg_l_OrthoZ(self)
	static int l_get_kinect_leg_l_OrthoZ(lua_State *L);
	
	// get_kinect_leg_r(self)
	static int l_get_kinect_leg_r(lua_State *L);
	
	// get_kinect_leg_r_OrthoX(self)
	static int l_get_kinect_leg_r_OrthoX(lua_State *L);
	
	// get_kinect_leg_r_OrthoZ(self)
	static int l_get_kinect_leg_r_OrthoZ(lua_State *L);
	
	// get_kinect_torso_rot(self)
	static int l_get_kinect_torso_rot(lua_State *L);
	
	// get_kinect_torso_roll(self)
	static int l_get_kinect_torso_roll(lua_State *L);
	
	// get_kinect_torso_x(self)
	static int l_get_kinect_torso_x(lua_State *L);
	
	// get_kinect_left_shoulder_flag(self)
	static int l_get_kinect_left_shoulder_flag(lua_State *L);
	
	// get_kinect_right_shoulder_flag(self)
	static int l_get_kinect_right_shoulder_flag(lua_State *L);
	
	// get_purrdata_face(self)
	static int l_get_pdata_face(lua_State *L);

	// get_gender(self)
	static int l_get_gender(lua_State *L);
	
	// get_kinect_face(self)
	static int l_get_kinect_face(lua_State *L);
